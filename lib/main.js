...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Services_Store.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Services_Store.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Foundation', 'Windows.System', 'Windows.ApplicationModel', 'Windows.Web.Http'];
